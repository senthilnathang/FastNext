...
import { usePageComponents } from '@/modules/builder/hooks/useComponents'
...
export default function Canvas({ 
  ...
  const rootInstances = instances.filter((instance: any) => !instance.parent_id)
  const sortedInstances = rootInstances.sort((a: any, b: any) => a.order_index - b.order_index)
      ...
      >
        <div className="bg-white shadow-sm border border-gray-200 min-h-[600px] p-4">
          {sortedInstances.length === 0 ? (
            ...
            <SortableContext 
              items={sortedInstances.map((i: any) => i.id.toString())}
