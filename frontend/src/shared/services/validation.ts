...
export class ValidationService {
  ...
  static validateFields(validations: Array<{ schema: z.ZodType<any>; data: unknown; fieldName: string }>): {
    isValid: boolean
...
export type ValidationResult<T> = ReturnType<typeof ValidationService.validate<T>>
export type AsyncValidator<T> = ReturnType<typeof ValidationService.createAsyncValidator<T>>
