...
export function ResponsiveWidget({
  ...
  const { mobile = 1, tablet = 1, desktop = 1, wide = 1 } = span;
...
export function TwoColumnDashboard({
  ...
  return (
    ...
    >
      <div className="lg:col-span-2 space-y-4">{leftColumn}</div>
...
export function HalfWidthWidget({
  children,
  className,
}: {
  children: React.ReactNode;
...
export function QuarterWidthWidget({
  children,
  className,
}: {
  children: React.ReactNode;
