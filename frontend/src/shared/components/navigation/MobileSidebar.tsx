        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 md:hidden">
            ...
            <motion.div
              ref={sidebarRef}
              variants={
                side === "left" ? sidebarVariants : rightSidebarVariants
              }
              initial="closed"
              animate="open"
              exit="closed"
            ...
            >
              ...
              {enableSwipe && (
                <div
                  className="absolute top-1/2 -translate-y-1/2 w-1 h-16 bg-gray-300 dark:bg-gray-600 rounded-full opacity-20"
                  style={{
