...
describe("MobileSidebar", () => {
  ...
  describe("Basic Rendering", () => {
    ...
    it("renders custom trigger button", () => {
      ...
      render(<MobileSidebar {...defaultProps} triggerButton={customTrigger} />);
  ...
  describe("Sidebar Behavior", () => {
    it("calls onOpenChange when trigger button is clicked", () => {
      ...
      render(
        <MobileSidebar {...defaultProps} onOpenChange={mockOnOpenChange} />,
      );
  ...
  describe("Body Scroll Management", () => {
    ...
    it("resets body overflow when closed", () => {
      const { rerender } = render(
        <MobileSidebar {...defaultProps} isOpen={true} />,
      );
      expect(document.body.style.overflow).toBe("hidden");
  ...
  describe("Customization Props", () => {
    it("applies custom width", () => {
      render(<MobileSidebar {...defaultProps} isOpen={true} width={350} />);
    ...
    it("applies custom width as string", () => {
      render(<MobileSidebar {...defaultProps} isOpen={true} width="300px" />);
    ...
    it("renders on right side", () => {
      render(<MobileSidebar {...defaultProps} isOpen={true} side="right" />);
