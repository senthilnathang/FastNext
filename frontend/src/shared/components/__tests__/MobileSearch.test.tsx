...
describe("MobileSearch", () => {
  ...
  describe("Basic Rendering", () => {
    ...
    it("renders with custom placeholder", () => {
      render(<MobileSearch {...defaultProps} placeholder="Custom search..." />);
  ...
  describe("Voice Search", () => {
    it("includes voice search elements when enabled", () => {
      render(<MobileSearch {...defaultProps} enableVoiceSearch={true} />);
    ...
    it("excludes voice search when disabled", () => {
      render(<MobileSearch {...defaultProps} enableVoiceSearch={false} />);
  ...
  describe("Filters", () => {
    it("shows filter button when enabled", () => {
      render(<MobileSearch {...defaultProps} enableFilters={true} />);
    ...
    it("shows filter count when provided", () => {
      render(
        <MobileSearch {...defaultProps} enableFilters={true} filterCount={5} />,
      );
