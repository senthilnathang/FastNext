...
describe("BottomNavigation", () => {
  ...
  describe("Navigation Behavior", () => {
    it("calls onItemClick when item is clicked", async () => {
      ...
      render(
        <BottomNavigation {...defaultProps} onItemClick={mockOnItemClick} />,
      );
    ...
    it("calls item onClick when provided", async () => {
      ...
      const itemsWithClick = [{ ...mockItems[0], onClick: mockItemClick }];
    ...
    it("shows active state for selected item", () => {
      render(<BottomNavigation {...defaultProps} activeItem="users" />);
    ...
    it("does not trigger click for disabled items", async () => {
      const user = userEvent.setup();
      const mockOnItemClick = jest.fn();
      const disabledItems = [{ ...mockItems[0], disabled: true }];
  ...
  describe("Overflow Handling", () => {
    it("shows overflow menu when items exceed maxVisibleItems", () => {
      render(<BottomNavigation items={manyItems} maxVisibleItems={4} />);
  ...
  describe("Scroll Behavior", () => {
    it("hides navigation when scrolling down", () => {
      render(<BottomNavigation {...defaultProps} hideOnScroll={true} />);
    ...
    it("does not hide navigation when hideOnScroll is false", () => {
      render(<BottomNavigation {...defaultProps} hideOnScroll={false} />);
  ...
  describe("Custom Styling", () => {
    it("applies custom className", () => {
      render(<BottomNavigation {...defaultProps} className="custom-class" />);
...
describe("useBottomNavigation", () => {
  function TestComponent({
    ...
    const { activeItem, handleItemClick } = useBottomNavigation(
      items,
      defaultActive,
    );
  ...
  it("handles items with href property", () => {
    const itemsWithHref = [{ ...mockItems[0], href: "/test-page" }];
