...
import { useSwipeGesture, usePointerSwipe } from '../useSwipeGesture'
...
describe('useSwipeGesture', () => {
  ...
  describe('Swipe Detection', () => {
    it('detects right swipe', () => {
      ...
      const moveEvent = createTouchEvent('touchmove', [{ clientX: 180, clientY: 100 }])
    ...
    it('detects up swipe', () => {
      ...
      const moveEvent = createTouchEvent('touchmove', [{ clientX: 100, clientY: 120 }])
      const endEvent = createTouchEvent('touchend', [])
    ...
    it('detects down swipe', () => {
      ...
      // Simulate swipe down
      const startEvent = createTouchEvent('touchstart', [{ clientX: 100, clientY: 100 }])
      const moveEvent = createTouchEvent('touchmove', [{ clientX: 100, clientY: 180 }])
      const endEvent = createTouchEvent('touchend', [])
  ...
  describe('Threshold Handling', () => {
    it('does not trigger swipe when distance is below threshold', () => {
      ...
      const startEvent = createTouchEvent('touchstart', [{ clientX: 100, clientY: 100 }])
      const moveEvent = createTouchEvent('touchmove', [{ clientX: 130, clientY: 100 }])
      const endEvent = createTouchEvent('touchend', [])
    ...
    it('uses custom threshold', () => {
      ...
      const startEvent = createTouchEvent('touchstart', [{ clientX: 100, clientY: 100 }])
      const moveEvent = createTouchEvent('touchmove', [{ clientX: 135, clientY: 100 }])
      const endEvent = createTouchEvent('touchend', [])
...
describe('usePointerSwipe', () => {
  ...
  describe('Pointer Swipe Detection', () => {
    it('detects right pointer swipe', () => {
      const onSwipeRight = jest.fn()
      const { result } = renderHook(() => usePointerSwipe({ onSwipeRight, threshold: 50 }))
