...
export const AutoGenerated: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Breadcrumb automatically generated from the current path /dashboard/projects/123",
      },
    },
  },
};
...
export const LongPath: Story = {
  ...
  parameters: {
    nextjs: {
      navigation: {
        pathname:
          "/compliance/ai-trust-center/model-inventory/fairness-dashboard/performance-metrics",
        query: {},
      },
    },
    docs: {
