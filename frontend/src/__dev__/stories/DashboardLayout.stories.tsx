...
export const Default: Story = {
      ...
      <div className="space-y-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            This is the main content area where dashboard content would be
            displayed.
          </p>
        </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Complete dashboard layout with sidebar, header, breadcrumbs, and main content area.",
      },
    },
  },
};
...
export const WithComplexContent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Dashboard layout with complex content including analytics cards, charts, and activity feed.",
      },
    },
  },
};
    ...
    children: (
      <div className="space-y-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            The dashboard layout properly supports dark mode theming across all
            components.
          </p>
        </div>
      </div>
