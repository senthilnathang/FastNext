        ...
        <TabsContent value="configs" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {mockConfigs.filter((c) => c.sensitive).length}
                </div>
                <p className="text-xs text-muted-foreground">
                  Protected values
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {mockConfigs.filter((c) => c.restartRequired).length}
                </div>
                <p className="text-xs text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                System configuration parameters and values
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="templates" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Pre-defined configuration sets for different environments
              </CardDescription>
            </CardHeader>
            <CardContent>
                          ...
                          <div className="mt-2 space-y-1">
                            ...
                            {template.configs.length > 3 && (
                              <div className="text-sm text-gray-500">
                                +{template.configs.length - 3} more
                                configurations
                              </div>
                            )}
                          </div>
        ...
        <TabsContent value="history" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track all configuration changes and rollback options
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-medium">
                          {mockConfigs.find((c) => c.id === entry.configId)
                            ?.key || "Unknown Config"}
                        </div>
                        <div className="text-sm text-gray-600">
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              configuration change? This will restore the
                              previous value.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
        ...
        <TabsContent value="validation" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Validate configuration settings and check for issues
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2 text-yellow-600">
                    ...
                    <span className="text-sm">
                      2 configurations require restart to take effect
                    </span>
                  </div>
                </div>
              </div>
      ...
      {selectedConfig && (
        ...
        >
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>
                Configuration Details - {selectedConfig.key}
              </DialogTitle>
              <DialogDescription>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="text-sm">
                  {format(
                    new Date(selectedConfig.lastModified),
                    "MMM dd, yyyy HH:mm",
                  )}{" "}
                  by {selectedConfig.modifiedBy}
                </div>
              </div>
            </div>
          </DialogContent>
