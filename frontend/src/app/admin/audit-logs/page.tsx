            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-orange-600">
                  {mockStats.severityCounts.error +
                    mockStats.severityCounts.critical}
                </div>
        ...
        <TabsContent value="analytics" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {Object.entries(mockStats.categoryCounts).map(
                    ([category, count]) => (
                      <div
                        key={category}
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <div className="w-20 h-2 bg-gray-200 rounded">
                            <div
                              ...
                              style={{
                                width: `${(count / Math.max(...Object.values(mockStats.categoryCounts))) * 100}%`,
                              }}
                            />
                          </div>
                        </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Users with the most audit log entries
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Audit log activity over the last 24 hours
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 mt-2">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">
                          {selectedLog.metadata.location || "Unknown Location"}
                        </span>
                      </div>
                      <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-xs text-gray-500">
                          Session: {selectedLog.metadata.sessionId}
                        </span>
                      </div>
                    </div>
                  </div>
