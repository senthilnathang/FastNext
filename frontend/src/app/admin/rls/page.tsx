    ...
    <div className="container mx-auto p-8">
      ...
      <div className="mb-6">
        <p className="text-muted-foreground">
          Manage data access policies, security rules, and monitor access
          patterns across your application. Row Level Security (RLS) ensures
