...
export default function WorkflowVerifyPage() {
  ...
  const testDataReading = async () => {
    await Promise.all([refetchTypes(), refetchTemplates(), refetchInstances()]);
  };
  ...
  const tests = [
    ...
    },
    {
      ...
      description:
        "Test Create, Read, Update, Delete operations for workflow types",
      testFn: testWorkflowTypeCRUD,
    },
    {
      name: "Workflow Template CRUD",
      description:
        "Test Create, Read, Update, Delete operations for workflow templates with nodes/edges",
    ...
    <div className="container mx-auto px-4 py-6 max-w-4xl">
      <div className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            <strong>Test Information:</strong> These tests will create, modify,
            and delete test data to verify the workflow system is working
            correctly. All test data will be cleaned up automatically.
          </AlertDescription>
        </Alert>
      </div>
    </div>
