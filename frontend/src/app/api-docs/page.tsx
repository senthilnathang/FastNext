  ...
  const apiEndpoints = [
    {
      ...
      endpoints: [
        ...
        },
        {
          ...
          description: "Test and validate JWT token",
        },
        {
          method: "POST",
    ...
    },
    {
      ...
      endpoints: [
        ...
        },
        {
          method: "GET",
          path: "/audit-trails/",
          description: "Get audit trails (admin only)",
        },
      ],
    },
    {
      ...
      endpoints: [
        {
          method: "GET",
          path: "/workflow-types/",
          description: "List workflow types",
        },
        {
          method: "POST",
          path: "/workflow-types/",
          description: "Create workflow type",
        },
        {
          method: "GET",
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Interactive API documentation for the FastNext Framework. Test
          endpoints, view schemas, and explore all available operations.
        </p>
        {user && (
        ...
        <TabsContent value="interactive" className="space-y-4">
          <Card className="p-6">
            ...
            <p className="text-muted-foreground mb-6">
              Use the interactive interface below to test API endpoints
              directly. Authentication is automatically handled when logged in.
            </p>
          </Card>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Most endpoints require authentication. You can test in two
                  ways:
                </p>
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <p>
                      <strong>Automatic:</strong> Log in through the frontend
                      application. Your token will be automatically included in
                      API requests.
                    </p>
                  </div>
                  <div className="flex items-start gap-2">
                    ...
                    <p>
                      <strong>Manual:</strong> Use the &ldquo;Authorize&rdquo;
                      button in Swagger UI and enter your bearer token manually.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Test the complete CRUD (Create, Read, Update, Delete)
                  lifecycle:
                </p>
                <div className="grid gap-4 md:grid-cols-2">
                  <Card className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use POST endpoints to create new resources. Provide
                  ...
                  <Card className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use GET endpoints to retrieve resources. Test both list
                      and individual resource endpoints.
                    </p>
                  </Card>
                  <Card className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use PUT endpoints to modify existing resources. Include
                  ...
                  <Card className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use DELETE endpoints to remove resources. Be careful -
                      this operation is usually irreversible.
                    </p>
                  </Card>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-2 text-sm">
                  <div className="flex items-center gap-3">
                    <Badge className="bg-green-500 w-12 justify-center">
                      200
                    </Badge>
                    <span>Success - Request completed successfully</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Badge className="bg-blue-500 w-12 justify-center">
                      201
                    </Badge>
                    <span>Created - Resource created successfully</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Badge className="bg-red-500 w-12 justify-center">
                      400
                    </Badge>
                    <span>Bad Request - Invalid request data</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Badge className="bg-orange-500 w-12 justify-center">
                      401
                    </Badge>
                    <span>Unauthorized - Authentication required</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Badge className="bg-purple-500 w-12 justify-center">
                      404
                    </Badge>
