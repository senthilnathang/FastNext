...
def create_product_model() -> ModelDefinition:
    ...
    price_validation = ValidationRule(
        min_value=0, error_message="Price must be a positive number"
    )
...
def main():
    ...
    try:
        ...
        product_generator = BackendScaffoldGenerator(
            product_model, "/home/sen/FastNext/backend"
        )
    ...
    try:
        ...
        blog_generator = BackendScaffoldGenerator(
            blog_model, "/home/sen/FastNext/backend"
        )
