...
def upgrade() -> None:
    ...
    op.add_column(
        "activity_logs", sa.Column("event_id", sa.String(length=36), nullable=True)
    )
    op.add_column(
        "activity_logs",
    ...
    op.add_column(
        "activity_logs", sa.Column("username", sa.String(length=100), nullable=True)
    )
    ...
    op.add_column(
        "activity_logs", sa.Column("request_headers", sa.JSON(), nullable=True)
    )
    op.add_column(
        "activity_logs", sa.Column("response_time_ms", sa.Integer(), nullable=True)
    )

    # Geographic and session info
    op.add_column(
        "activity_logs", sa.Column("country_code", sa.String(length=2), nullable=True)
    )
    op.add_column(
        "activity_logs", sa.Column("city", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "activity_logs", sa.Column("session_id", sa.String(length=100), nullable=True)
    )
    ...
    op.add_column(
        "activity_logs", sa.Column("affected_users_count", sa.Integer(), nullable=True)
    )

    # System context
    op.add_column(
        "activity_logs", sa.Column("server_name", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "activity_logs", sa.Column("environment", sa.String(length=20), nullable=True)
    )
    op.add_column(
        "activity_logs",
    ...
    op.create_index(
        "ix_activity_logs_event_id", "activity_logs", ["event_id"], unique=True
    )
    op.create_index(
        "ix_activity_logs_correlation_id", "activity_logs", ["correlation_id"]
    )
