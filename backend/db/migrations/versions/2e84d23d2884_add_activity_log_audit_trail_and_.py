...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "level",
            sa.Enum("INFO", "WARNING", "ERROR", "CRITICAL", name="activitylevel"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_audit_trails_created_at"), "audit_trails", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_audit_trails_entity_id"), "audit_trails", ["entity_id"], unique=False
    )
    op.create_index(
        op.f("ix_audit_trails_entity_type"),
        "audit_trails",
        ["entity_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_audit_trails_operation"), "audit_trails", ["operation"], unique=False
    )
    op.create_index(
        op.f("ix_audit_trails_user_id"), "audit_trails", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_security_settings_user_id"),
        "security_settings",
        ["user_id"],
        unique=True,
    )
