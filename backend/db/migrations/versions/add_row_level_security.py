...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "action",
            sa.Enum("SELECT", "INSERT", "UPDATE", "DELETE", "ALL", name="rlsaction"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_rls_policies_name"), "rls_policies", ["name"], unique=False
    )
    op.create_index(
        op.f("ix_rls_policies_entity_type"),
        "rls_policies",
        ["entity_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_policies_table_name"), "rls_policies", ["table_name"], unique=False
    )
    op.create_index(
        op.f("ix_rls_policies_policy_type"),
        "rls_policies",
        ["policy_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_policies_action"), "rls_policies", ["action"], unique=False
    )
    op.create_index(
        op.f("ix_rls_policies_organization_id"),
        "rls_policies",
        ["organization_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_rls_rule_assignments_id"), "rls_rule_assignments", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_rls_rule_assignments_policy_id"),
        "rls_rule_assignments",
        ["policy_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_rule_assignments_entity_type"),
        "rls_rule_assignments",
        ["entity_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_rule_assignments_entity_id"),
        "rls_rule_assignments",
        ["entity_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_rule_assignments_user_id"),
        "rls_rule_assignments",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_rls_contexts_session_id"), "rls_contexts", ["session_id"], unique=False
    )
    op.create_index(
        op.f("ix_rls_contexts_user_id"), "rls_contexts", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_rls_contexts_organization_id"),
        "rls_contexts",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_contexts_tenant_id"), "rls_contexts", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_rls_audit_logs_id"), "rls_audit_logs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_rls_audit_logs_request_id"),
        "rls_audit_logs",
        ["request_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_audit_logs_session_id"),
        "rls_audit_logs",
        ["session_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_audit_logs_user_id"), "rls_audit_logs", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_rls_audit_logs_policy_id"),
        "rls_audit_logs",
        ["policy_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_audit_logs_entity_type"),
        "rls_audit_logs",
        ["entity_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_audit_logs_entity_id"),
        "rls_audit_logs",
        ["entity_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_audit_logs_action"), "rls_audit_logs", ["action"], unique=False
    )
    op.create_index(
        op.f("ix_rls_audit_logs_access_granted"),
        "rls_audit_logs",
        ["access_granted"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rls_audit_logs_created_at"),
        "rls_audit_logs",
        ["created_at"],
        unique=False,
    )
