...
class TestBlogPostAPI:
    ...
    def test_create_blog_post(self, client: TestClient, normal_user_token_headers: dict):
    ...
    def test_read_blog_post(self, client: TestClient, normal_user_token_headers: dict, db: Session):
    ...
    def test_update_blog_post(self, client: TestClient, normal_user_token_headers: dict, db: Session):
    ...
    def test_delete_blog_post(self, client: TestClient, normal_user_token_headers: dict, db: Session):
    ...
    def test_list_blog_posts(self, client: TestClient, normal_user_token_headers: dict, db: Session):
