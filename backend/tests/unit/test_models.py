...
class TestPermissionModel:
    ...
    def test_permission_name_unique_constraint(self, db):
        ...
        perm1 = Permission(name="test_perm", action="read", resource="res1", category="cat1")
        perm2 = Permission(name="test_perm", action="write", resource="res2", category="cat2")
...
class TestWorkflowModels:
    ...
    def test_workflow_template_with_type_relationship(self, db, admin_user, sample_workflow_type):
