...
class TestUsersAPI:
    ...
    def test_get_users_admin(self, client, admin_headers, admin_user, regular_user):
        ...
        assert "hashed_password" not in user_data  # Sensitive data should not be returned
    ...
    def test_create_user_duplicate_email(self, client, admin_headers, admin_user, test_data_factory):
    ...
    def test_create_user_duplicate_username(self, client, admin_headers, admin_user, test_data_factory):
    ...
    def test_delete_user_admin(self, client, admin_headers, regular_user):
        ...
        get_response = client.get(f"/api/v1/users/{regular_user.id}", headers=admin_headers)
    ...
    def test_toggle_user_status_admin(self, client, admin_headers, regular_user):
        ...
        response = client.patch(
            f"/api/v1/users/{regular_user.id}/toggle-status",
            headers=admin_headers
        )
    ...
    def test_toggle_superuser_status_protection(self, client, admin_headers, admin_user):
