...
def generate_status_report():
    ...
    try:
        ...
        if response.status_code == 401:
            ...
            print(
                f"❌ /auth/me (invalid token): UNEXPECTED STATUS {response.status_code}"
            )
    except Exception as e:
    ...
    public_endpoints = ["/health", "/debug", "/docs"]
    ...
    print(
        "✅ REQUIREMENT MET: Every menu except /login and landing page requires authentication"
    )
