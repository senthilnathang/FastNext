...
from app.middleware.rls_middleware import (
    require_rls_access, rls_filter_query, rls_audit_action, get_rls_service
)
...
async def create_project_rls(
    *,
    ...
    try:
        ...
        rls_service = get_rls_service(request)
        if rls_service:
            await _create_project_rls_policies(
                rls_service, project, current_user.id
            )
...
@require_rls_access(RLSEntityType.PROJECT, RLSAction.SELECT, entity_id_param="project_id")
...
@require_rls_access(RLSEntityType.PROJECT, RLSAction.UPDATE, entity_id_param="project_id")
...
@require_rls_access(RLSEntityType.PROJECT, RLSAction.DELETE, entity_id_param="project_id")
    ...
    *,
    ...
    return {
        ...
        "user_context": {
            ...
            "permissions": getattr(request.state, 'rls_context', {}).get('permissions', [])
        }
    }
