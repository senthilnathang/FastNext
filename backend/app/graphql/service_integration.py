...
class GraphQLServiceIntegration:
    ...
    async def get_current_user(self) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "createdAt": self.current_user.created_at.isoformat() if self.current_user.created_at else None,
            "updatedAt": self.current_user.updated_at.isoformat() if self.current_user.updated_at else None,
            "lastLoginAt": self.current_user.last_login_at.isoformat() if self.current_user.last_login_at else None,
        }
    ...
    # Asset Services
    async def get_assets(self, project_id: Optional[int] = None) -> List[Dict[str, Any]]:
        """Get assets"""
    ...
    def _format_component(self, component: Component) -> Dict[str, Any]:
        ...
        return {
            ...
            "project": self._format_project(component.project) if component.project else None,
        }
