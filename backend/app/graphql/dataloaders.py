...
class UserDataLoader:
    ...
    @staticmethod
    async def load_users(keys: List[int], context: GraphQLContext) -> List[Optional[User]]:
...
class ProjectDataLoader:
    ...
    @staticmethod
    async def load_projects(keys: List[int], context: GraphQLContext) -> List[Optional[Project]]:
    ...
    @staticmethod
    async def load_projects_by_user(keys: List[int], context: GraphQLContext) -> List[List[Project]]:
...
class PageDataLoader:
    ...
    @staticmethod
    async def load_pages(keys: List[int], context: GraphQLContext) -> List[Optional[Page]]:
    ...
    @staticmethod
    async def load_pages_by_project(keys: List[int], context: GraphQLContext) -> List[List[Page]]:
...
class ComponentDataLoader:
    ...
    @staticmethod
    async def load_components(keys: List[int], context: GraphQLContext) -> List[Optional[Component]]:
    ...
    @staticmethod
    async def load_components_by_project(keys: List[int], context: GraphQLContext) -> List[List[Component]]:
...
class ProjectMemberDataLoader:
    ...
    @staticmethod
    async def load_members_by_project(keys: List[int], context: GraphQLContext) -> List[List[ProjectMember]]:
    ...
    @staticmethod
    async def load_members_by_user(keys: List[int], context: GraphQLContext) -> List[List[ProjectMember]]:
...
class AssetDataLoader:
    ...
    @staticmethod
    async def load_assets_by_project(keys: List[int], context: GraphQLContext) -> List[List[Asset]]:
...
def create_dataloaders(context: GraphQLContext) -> Dict[str, DataLoader]:
    ...
    return {
        ...
        'components_by_project_loader': DataLoader(
            load_fn=lambda keys: ComponentDataLoader.load_components_by_project(keys, context)
        ),
        'members_by_project_loader': DataLoader(
            load_fn=lambda keys: ProjectMemberDataLoader.load_members_by_project(keys, context)
        ),
        'members_by_user_loader': DataLoader(
            load_fn=lambda keys: ProjectMemberDataLoader.load_members_by_user(keys, context)
        ),
