...
class GraphQLTester:
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                return {
                    ...
                    "has_graphiql": "GraphQL Interface" in response.text if response.status_code == 200 else False
                }
    ...
    async def test_graphql_query(self, query: str, variables: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    async def run_comprehensive_test(self) -> Dict[str, Any]:
        ...
        results["tests"]["auth_with_token"] = await self.test_authentication("mock_token")
    ...
    def print_test_summary(self, results: Dict[str, Any]):
        ...
        print(f"  • Without token: {'✅ PASS' if not auth_no_token.get('success') else '❌ FAIL'}")
        print(f"  • With token: {'✅ PASS' if auth_with_token.get('success') else '❌ FAIL'}")
