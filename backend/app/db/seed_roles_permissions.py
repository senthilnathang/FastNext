...
def create_default_permissions(db: Session) -> None:
    ...
    default_permissions = [
        ...
        {
            "name": "workflow_type_create",
            "description": "Create workflow types",
            "category": PermissionCategory.WORKFLOW_TYPE,
            "action": PermissionAction.CREATE,
            "is_system_permission": True,
        },
        {
            "name": "workflow_type_read",
            "description": "View workflow types",
            "category": PermissionCategory.WORKFLOW_TYPE,
            "action": PermissionAction.READ,
            "is_system_permission": True,
        },
        {
            "name": "workflow_type_update",
            "description": "Edit workflow types",
            "category": PermissionCategory.WORKFLOW_TYPE,
            "action": PermissionAction.UPDATE,
            "is_system_permission": True,
        },
        {
            "name": "workflow_type_delete",
            "description": "Delete workflow types",
            "category": PermissionCategory.WORKFLOW_TYPE,
            "action": PermissionAction.DELETE,
            "is_system_permission": True,
        },
        {
            "name": "workflow_type_manage",
            "description": "Full workflow type management",
            "category": PermissionCategory.WORKFLOW_TYPE,
            "action": PermissionAction.MANAGE,
            "is_system_permission": True,
        },
        # Workflow Template permissions
        {
            ...
            "category": PermissionCategory.WORKFLOW_TEMPLATE,
            "action": PermissionAction.CREATE,
            "is_system_permission": True,
        },
        {
        ...
        },
        {
            ...
            "description": "Edit workflow templates",
            "category": PermissionCategory.WORKFLOW_TEMPLATE,
            "action": PermissionAction.UPDATE,
            "is_system_permission": True,
        },
        ...
        },
        {
            ...
            "description": "Full workflow template management",
            "category": PermissionCategory.WORKFLOW_TEMPLATE,
            "action": PermissionAction.MANAGE,
            "is_system_permission": True,
        },
        # Workflow Instance permissions
        {
            ...
            "category": PermissionCategory.WORKFLOW_INSTANCE,
            "action": PermissionAction.CREATE,
            "is_system_permission": True,
        },
        {
            "name": "workflow_instance_read",
            "description": "View workflow instances",
            "category": PermissionCategory.WORKFLOW_INSTANCE,
            "action": PermissionAction.READ,
            "is_system_permission": True,
        },
        {
            ...
            "description": "Edit workflow instances",
            "category": PermissionCategory.WORKFLOW_INSTANCE,
            "action": PermissionAction.UPDATE,
            "is_system_permission": True,
        },
        ...
        {
            "name": "workflow_instance_manage",
            "description": "Full workflow instance management",
            "category": PermissionCategory.WORKFLOW_INSTANCE,
            "action": PermissionAction.MANAGE,
            "is_system_permission": True,
        },
        # Workflow State permissions
        {
            ...
            "description": "Create workflow states",
            "category": PermissionCategory.WORKFLOW_STATE,
            "action": PermissionAction.CREATE,
            "is_system_permission": True,
        },
        {
            "name": "workflow_state_read",
        ...
        {
            "name": "workflow_state_update",
            "description": "Edit workflow states",
            "category": PermissionCategory.WORKFLOW_STATE,
            "action": PermissionAction.UPDATE,
            "is_system_permission": True,
        },
        {
            ...
            "description": "Delete workflow states",
            "category": PermissionCategory.WORKFLOW_STATE,
            "action": PermissionAction.DELETE,
            "is_system_permission": True,
        },
        {
            "name": "workflow_state_manage",
            "description": "Full workflow state management",
            "category": PermissionCategory.WORKFLOW_STATE,
            "action": PermissionAction.MANAGE,
            "is_system_permission": True,
        },
...
def assign_role_permissions(db: Session) -> None:
    ...
    role_permission_mappings = [
        ...
        (admin_role.id, permissions["workflow_type_manage"].id),
        (admin_role.id, permissions["workflow_template_manage"].id),
        (admin_role.id, permissions["workflow_instance_manage"].id),
        (admin_role.id, permissions["workflow_state_manage"].id),
        ...
        # Editor - workflow permissions
        (editor_role.id, permissions["workflow_type_create"].id),
        (editor_role.id, permissions["workflow_type_read"].id),
        (editor_role.id, permissions["workflow_type_update"].id),
        (editor_role.id, permissions["workflow_template_create"].id),
        (editor_role.id, permissions["workflow_template_read"].id),
        (editor_role.id, permissions["workflow_template_update"].id),
        (editor_role.id, permissions["workflow_instance_create"].id),
        (editor_role.id, permissions["workflow_instance_read"].id),
        (editor_role.id, permissions["workflow_instance_update"].id),
        ...
        (viewer_role.id, permissions["workflow_type_read"].id),
        (viewer_role.id, permissions["workflow_template_read"].id),
        (viewer_role.id, permissions["workflow_instance_read"].id),
        ...
        (member_role.id, permissions["workflow_type_read"].id),
        (member_role.id, permissions["workflow_template_read"].id),
        (member_role.id, permissions["workflow_instance_read"].id),
        (member_role.id, permissions["workflow_instance_update"].id),
    ]
