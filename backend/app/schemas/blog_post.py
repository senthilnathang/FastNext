...
class BlogPostBase(BaseModel):
    ...
    tags: Optional[Dict[str, Any]] = Field(None, description="Post tags as JSON array", example=['technology', 'tutorial', 'python'])
...
class BlogPostResponse(BlogPostBase, BaseResponseModel):
    ...
    tags: Dict[str, Any] = Field(None, description="Post tags as JSON array", example=['technology', 'tutorial', 'python'])
    author_id: int = Field(..., description="Post author")
    created_at: datetime
