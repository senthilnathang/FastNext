...
def upgrade():
    ...
    # Create enum types
    notification_type_enum = postgresql.ENUM('info', 'success', 'warning', 'error', 'system', name='notificationtype')
    notification_type_enum.create(op.get_bind(), checkfirst=True)

    notification_channel_enum = postgresql.ENUM('in_app', 'email', 'push', name='notificationchannel')
    ...
    op.create_table(
        ...
        sa.Column('channels', sa.String(length=255), nullable=False),  # JSON array of channels
