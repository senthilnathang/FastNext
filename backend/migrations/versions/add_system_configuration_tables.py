...
def upgrade() -> None:
    ...
    op.create_table('configuration_templates',
        ...
        sa.Column('supported_environments', sa.JSON(), nullable=False, default='["production", "staging", "development"]'),
        sa.Column('metadata_json', sa.JSON(), nullable=False, default='{}'),
        sa.Column('tags', sa.JSON(), nullable=False, default='[]'),
        sa.Column('version', sa.String(length=20), nullable=False, default='1.0.0'),
        sa.Column('is_deleted', sa.Boolean(), nullable=False, default=False),
    ...
    op.create_table('configuration_audit_logs',
        sa.Column('id', sa.Integer(), primary_key=True, index=True),
        sa.Column('configuration_key', sa.String(length=255), nullable=False, index=True),
    ...
    op.create_index('idx_system_configurations_category_active', 'system_configurations', ['category', 'is_active'])
    op.create_index('idx_system_configurations_environment', 'system_configurations', ['environment'])
    op.create_index('idx_configuration_templates_category_active', 'configuration_templates', ['category', 'is_active'])
    op.create_index('idx_configuration_audit_logs_key_action', 'configuration_audit_logs', ['configuration_key', 'action'])
    op.create_index('idx_configuration_audit_logs_timestamp', 'configuration_audit_logs', ['timestamp'])
...
def downgrade() -> None:
    ...
    op.drop_index('idx_configuration_templates_category_active', 'configuration_templates')
